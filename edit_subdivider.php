...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt_update = mysqli_prepare($conn, "UPDATE subdivided_titles SET date_filed=?, applicant_name=?, location=?, remarks=?, position=?, status=? WHERE lot_number=?");
        ...
        if (mysqli_stmt_execute($stmt_update)) {
            ...
            header('location: edit-lot.php?lot_number=' . $lot_number);//Modify moto
            exit();
        }
